                ...
                <div class="panel panel-default"> 
                    ...
                    <div class="panel-body">          
                        <ul class="nav nav-pills"> 
                            <li role="presentation" class="active"><a href="<?php echo base_url(); ?>manager/all_projects">All Projects</a></li> 
                            <li role="presentation"><a href="<?php echo base_url(); ?>manager/my_projects">My Projects</a></li>
                        </ul>
