                        ...
                        <li><a class="category" href="#">Project Managers</a>
                            <ul>
                                <?php foreach ($viewManager as $view): ?>                                        
                                    <li>
                                        <a class="category" href="<?php echo base_url() . 'manager/view_profile/' . $view['username']; ?>"><?php echo $view['fname'] . ' ' . $view['lname']; ?></a>                                     
                                        <a href="<?php echo base_url() . 'manager/delete_staff/' . $view['projectID'] . '/' . $view['userID']; ?>"><i class='fa fa-remove'></i></a>                                                                    
                                    </li>
                                <?php endforeach; ?>  
                            </ul>
                        </li>
                                ...
                                <li><a class="category" href="#">Developers</a>
                                    <ul>   
                                        <?php foreach ($developer as $view): ?>                                        
                                            <li>
                                                <a class="category" href="<?php echo base_url() . 'manager/view_profile/' . $view['username']; ?>"><?php echo $view['fname'] . ' ' . $view['lname']; ?></a>
                                                <a href="<?php echo base_url() . 'manager/delete_staff/' . $view['projectID'] . '/' . $view['userID']; ?>"><i class='fa fa-remove'></i></a></li>
                                        <?php endforeach; ?> 
                                    </ul>      
                                </li>
                                <li><a class="category" href="#">Designers</a>
                                    <ul>   
                                        <?php foreach ($designer as $view): ?>                                        
                                            <li> <a class="category" href="<?php echo base_url() . 'manager/view_profile/' . $view['username']; ?>"><?php echo $view['fname'] . ' ' . $view['lname']; ?></a>
                                                <a href="<?php echo base_url() . 'manager/delete_staff/' . $view['projectID'] . '/' . $view['userID']; ?>"><i class='fa fa-remove'></i></a>
                                            </li>
                                        <?php endforeach; ?> 
                                    </ul> 
